...
%
%  Compiles with any engine, so Overleaf's default (pdfLaTeX) works
%  with no setup:  pdflatex notes-template.tex
%  XeLaTeX/LuaLaTeX are also supported and will use the Petrona and
%  Work Sans brand fonts if those are installed locally.
%
